<template>
  <div class="Home">
    ...
    <div class="swipe">
      <mt-swipe :auto="4000">
        <mt-swipe-item>
          <router-link to="goodDetail?id=4"><img
            src="https://shopstatic.vivo.com.cn/vivoshop/commodity/20171113/20171113232814110405_original.jpg"
            alt="轮播图"></router-link>
        </mt-swipe-item>
        <mt-swipe-item>
          <router-link to="choose"><img
            src="https://shopstatic.vivo.com.cn/vivoshop/commodity/20171122/20171122174336166279_original.jpg"
            alt="轮播图"></router-link>
        </mt-swipe-item>
      </mt-swipe>
    </div>
    ...
    <div class="HomeList">
      <ul>
        <li>
          <div @click="xuangou"><img src="/static/img/xuangou.jpg" alt="选购"></div>
        </li>
        <li>
          <div @click="parts"><img src="/static/img/peijian.jpg" alt="配件"></div>
        </li>
        <li>
          <div @click="btn"><img src="/static/img/pingbao.jpg" alt="屏保"></div>
        </li>
        <li>
          <div @click="btn"><img src="/static/img/dingzhi.jpg" alt="定制"></div>
        </li>
      </ul>
    </div>
    <!--爆款产品-->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      btn: function () {
        MessageBox('提示', '希望您喜欢项目Thank you');
      }
    },
  }
</script>
